...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`bg-secondary-800 text-white transition-all duration-300 ${
        collapsed ? 'w-16' : 'w-64'
      } hidden md:block`}
    >
      <div className="flex items-center justify-between h-16 px-4 border-b border-secondary-700">
        ...
        <button
          ...
          className="p-1 rounded-md hover:bg-secondary-700 focus:outline-none"
        >
          {collapsed ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <nav className="mt-4 px-2">
        <div className="space-y-2">
          ...
          <Link
            href="/"
            className={`flex items-center px-4 py-2 text-sm rounded-lg hover:bg-secondary-700 ${
          ...
          >
            ...
            {!collapsed && <span className="ml-3">Revenue</span>}
          </Link>
